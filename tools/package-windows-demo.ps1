...
try {
    ...
    # Manifest mode is deliberately rooted at the checked-in dependency record.
    # Keep its installed tree in this disposable packaging directory so a local
    # package run cannot accidentally reuse or modify a global vcpkg install.
