...
| SDL deterministic load | Current local checkout; clean strict SDL2 builds at `-O0` and `-O2` | RUNS | Both optimisation levels reproduced the 600-tick stream including the interactive dropship start: fired 24, explosions 16, crushes 0, effects 836, awake 3790, canonical hash `4f038249`. No timing threshold was applied. |
